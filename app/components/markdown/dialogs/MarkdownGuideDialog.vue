  ...
  <Dialog :open="open" @update:open="$emit('update:open', $event)">
    <DialogContent class="!max-w-3xl">
      <DialogHeader>
        ...
        <DialogDescription class="text-gray-700 dark:text-gray-300">
      ...
      <div class="space-y-4 py-2">
        <!-- Basic Syntax -->
        <div class="space-y-3">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Basic Syntax</h3>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              <div class="flex items-center gap-2">
                <code class="bg-gray-100 px-2 py-1 rounded text-sm dark:bg-gray-800 dark:text-gray-100"># Heading</code>
              ...
              <div class="flex items-center gap-2">
                <code class="bg-gray-100 px-2 py-1 rounded text-sm dark:bg-gray-800 dark:text-gray-100">**bold**</code>
                <span class="text-sm text-gray-600 dark:text-gray-400">→ <strong>bold</strong></span>
              </div>
              <div class="flex items-center gap-2">
                <code class="bg-gray-100 px-2 py-1 rounded text-sm dark:bg-gray-800 dark:text-gray-100">*italic*</code>
        ...
        <!-- Advanced Features -->
        <div class="space-y-3">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Advanced Features</h3>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              <div class="flex items-center gap-2">
                <code
              ...
              <div class="flex items-center gap-2">
                <code class="bg-gray-100 px-2 py-1 rounded text-sm dark:bg-gray-800 dark:text-gray-100">| A | B |</code>
            ...
            <div class="space-y-2">
              <div class="flex items-center gap-2">
                <code class="bg-gray-100 px-2 py-1 rounded text-sm dark:bg-gray-800 dark:text-gray-100">> quote</code>
