        ...
        <div class="w-full max-h-[65vh] overflow-y-auto">
          ...
          <div class="p-1 grid grid-cols-2 gap-3">
            <button ref="blankBtn" @click="selectTemplate('blank')"
              ...
              <span class="font-semibold text-sm text-gray-900 dark:text-white">Blank Document</span>
            ...
            <button @click="selectTemplate('welcome')"
              ...
              <span class="font-semibold text-sm text-gray-900 dark:text-white">Welcome Guide</span>
            ...
            <button @click="selectTemplate('whitepaper')"
              ...
              <span class="font-semibold text-sm text-gray-900 dark:text-white">Whitepaper Template</span>
            ...
            <button @click="selectTemplate('research')"
              ...
              <span class="font-semibold text-sm text-gray-900 dark:text-white">Research Paper</span>
