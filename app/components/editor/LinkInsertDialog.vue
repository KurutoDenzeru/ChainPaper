<template>
  <Dialog :open="isOpen" @update:open="handleOpenChange">
    <DialogContent class="sm:max-w-md">
      <DialogHeader>
        ...
        <DialogDescription>
          Add a hyperlink to your document. The link will be clickable and can navigate to external websites or internal pages.
        </DialogDescription>
      </DialogHeader>
      ...
      <div class="space-y-4">
        <!-- URL Input -->
        <div class="space-y-2">
          <Label for="url">URL or Web Address</Label>
          <Input
            id="url"
            v-model="url"
            type="url"
  ...
  <!-- Options (no title required) -->
      ...
      <DialogFooter>
        ...
        <Button @click="handleInsert" :disabled="!url.trim()">Insert Link</Button>
      </DialogFooter>
    </DialogContent>
  </Dialog>
</template>
