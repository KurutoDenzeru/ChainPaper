<template>
  <div class="flex px-2 sm:px-4 py-2 bg-white border-b border-gray-200 min-h-14 gap-1 sm:gap-2 overflow-x-auto">
            ...
            <div class="md:hidden space-y-1">
              ...
              <div class="grid grid-cols-4 gap-1">
                <Button 
                  variant="ghost" 
                  size="sm" 
                  :class="['h-8', { 'bg-gray-100': isUnderline }]"
                  @click="toggleUnderline"
                >
                  <Underline class="w-4 h-4" />
                </Button>
                <Button 
                  variant="ghost" 
                  size="sm" 
                  :class="['h-8', { 'bg-gray-100': isStrikethrough }]"
                  @click="toggleStrikethrough"
                >
                  <Strikethrough class="w-4 h-4" />
                </Button>
            ...
            <div class="md:hidden space-y-1">
              ...
              <div class="grid grid-cols-4 gap-1">
                <Button 
                  variant="ghost" 
                  size="sm" 
                  :class="['h-8', { 'bg-gray-100': alignment === 'left' }]"
                  @click="setAlignment('left')"
                >
                  <AlignLeft class="w-4 h-4" />
                </Button>
                <Button 
                  variant="ghost" 
                  size="sm" 
                  :class="['h-8', { 'bg-gray-100': alignment === 'center' }]"
                  @click="setAlignment('center')"
                >
                  <AlignCenter class="w-4 h-4" />
                </Button>
                <Button 
                  variant="ghost" 
                  size="sm" 
                  :class="['h-8', { 'bg-gray-100': alignment === 'right' }]"
                  @click="setAlignment('right')"
                >
                  <AlignRight class="w-4 h-4" />
                </Button>
                <Button 
                  variant="ghost" 
                  size="sm" 
                  :class="['h-8', { 'bg-gray-100': alignment === 'justify' }]"
                  @click="setAlignment('justify')"
                >
                  <AlignJustify class="w-4 h-4" />
                </Button>
            ...
            <div class="space-y-1">
              ...
              <div class="grid grid-cols-4 gap-1">
                <Button 
                  variant="ghost" 
                  size="sm" 
                  :class="['h-8 md:hidden', { 'bg-gray-100': isOrderedList }]"
                  @click="toggleOrderedList"
                >
                  <ListOrdered class="w-4 h-4" />
                </Button>
